...
const RecentSearches = ({ 
    ...
    return ( 
        <div className={`recents top-0 left-[0] min-w-full fixed h-screen place-self-center bg-[#f1f1f1] md:relative md:w-[40vw] md:mx-0 md:max-h-[532px] md:left-x-[0%] p-4 z-[150] overflow-y-scroll`}
        style={{
